...
def sim_config():
    ...
    layer_params = {'encoder_in': 8, 'encoder_out': 30, 'decoder_in': 30, 'decoder_out': 8, 'classifier_in': 30,
                    'classifier_out': 2}

    # Set sim parameters
    sim_params = OrderedDict({'encoder_out_name': 'lin1_encoder', 'train_ratio': 0.7, 'AE_epochs': 50, 
                              ...
                              'inplace_noise': True, 'save_model': True, 'metric':'cosine', 'verbose': True})
