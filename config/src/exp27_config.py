...
def main(**kwargs):
    ...
    exp27['dataset'] = {}
    exp27['sim'] = {}
    exp27['mode'] = 'benchmark'
    exp27['model'] = 'nn-sig'
    exp27['exp_name'] = 'exp27'
    exp27['dataset_dir'] = osp.abspath(osp.join(Path(__file__).parent, '..', '..', 'data', 'benchmark_stimuli', 'N8'))
    exp27['save_dir'] = osp.abspath(osp.join(Path(__file__).parent, '..', '..', 'results'))
    
    ## Macrofeature parameters
    exp27['dataset']['size'] = 1000
    exp27['dataset']['i'] = None
    exp27['dataset']['k'] = None
    exp27['dataset']['l'] = None
    exp27['dataset']['m'] = None
    exp27['dataset']['s'] = None
    exp27['dataset']['s_list'] = None

    ## Category parameters
    ### In order, each element contains: k, d, pdi, pd
    exp27['dataset']['custom'] = None 
    
    # Simulation parameters
    exp27['sim']['layer_params'], exp27['sim']['sim_params'] = sim_config() 
    
    with open(save_fname, 'w') as f:
        json.dump(exp27, f, indent=3)
