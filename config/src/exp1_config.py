...
def main():
    ...
    exp1['model'] = 'nn'
    exp1['exp_name'] = 'exp1'
    exp1['data_dir'] = osp.abspath(osp.join(Path(__file__).parent,'..', 'data', 'binary', 'exp1'))
    exp1['dataset_dir'] = osp.abspath(osp.join(Path(__file__).parent, '..', 'data', 'binary', 'exp1', 'categories'))
