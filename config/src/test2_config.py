...
def sim_config():
    ...
    # Set sim parameters
    sim_params = OrderedDict({'train_ratio': 0.8, 'AE_epochs': 15, 
                              ...
                              'class_wd': 10e-3, 'class_monitor': None, 'class_thresh': None, 'training': 'fixed', 'inplace_noise': True, 'save_model': True, 'metric':'cosine', 'verbose': False})
...
def main():
    ...
    test2['dataset_dir'] = osp.abspath(osp.join(Path(__file__).parent, '..', '..', 'test', 'test_results', 'data', 'categories'))
